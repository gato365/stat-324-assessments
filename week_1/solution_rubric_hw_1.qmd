...
$$H_0: \beta_1 = \beta_2 = 0  $$
-   **H₁:** At least one βᵢ ≠ 0 (for i = 1 or 2)
...
**Justification Using Practical Reasoning:** 
- Since `drat` does not contribute statistically and the change in adjusted $R^2$, AIC, and BIC between Models 2 and 3 is **minimal**, there is no strong evidence of practical gain. 
