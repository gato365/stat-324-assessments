...
model_3 <- lm(price ~ sqft * beds, data = sacramento_df)
model_4 <- lm(price ~ sqft_centered  * beds_centered , data = sacramento_df)
model_5 <- lm(price ~ sqft + beds + baths, data = sacramento_df)
model_6 <- lm(price ~ sqft + RegionGroup, data = sacramento_df)
model_7 <- lm(price ~ sqft * RegionGroup, data = sacramento_df)
```
